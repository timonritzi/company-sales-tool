const API_PATH = 'wss://live.auto-zuerisee.ch/wss/chat/admin/'
...
class WebSocketService {
  ...
  connect() {
    ...
    const path = API_PATH + this.roomName + '/';
  ...
  disconnect() {
    //console.log(this.chandeDisconnect)
    this.chandeDisconnect = true
