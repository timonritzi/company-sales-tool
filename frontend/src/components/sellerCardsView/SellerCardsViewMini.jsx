...
export const SellerCardsViewMini = (props) => {
    ...
    return (
        <>
            ...
            <section className="mainContainerViewCardsSeller" >
                ...
                <a href="https://autograf.mini.ch/de" className="link-logo"><img className="logo-sellercards" src={logoAutoG}/></a>

                <section className="sectionContainerCards">
                    {sellers.length ? sellers.map(seller => {
                        if (seller.autohaus === "AutoGraf-MINI" || seller.username === "siegfriedschlesinger") {
